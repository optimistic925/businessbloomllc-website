  ...
  return (
    <div className="min-h-screen bg-[#0B0F1A] text-white overflow-x-hidden">
      ...
      <main>
        ...
        <section className="py-20 border-y border-white/5"><div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 text-center"><p className="text-[#BDA4FF] text-sm font-bold uppercase tracking-wider">How It Works</p><h2 className="mt-3 text-3xl font-black">Choose a solution → get the tools → implement the system → automate where appropriate</h2></div></section>
