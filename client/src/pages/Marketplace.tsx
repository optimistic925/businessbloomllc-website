    ...
    <div className="min-h-screen bg-[#0B0F1A] text-white overflow-x-hidden">
      ...
      <main className="pt-28 pb-20">
        ...
        <section id="professional-systems" className="scroll-mt-24 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mt-20 rounded-3xl border border-[#7C3AED]/25 bg-[#7C3AED]/8 p-7 sm:p-9">
          ...
          <div className="mt-7 text-sm text-white/55">Current six-system individual retail value: <strong className="text-white">{formatCurrency(bundleEconomics.individualRetailValueCents)}</strong> · Complete bundle: <strong className="text-[#14B8A6]">{formatCurrency(bundleEconomics.bundlePriceCents)}</strong> · Savings: <strong className="text-white">{(bundleEconomics.savingsPercent * 100).toFixed(1)}%</strong>. Sales System is finalized and priced; it remains unpublished as an individual Marketplace product until protected paid delivery is READY.</div>
        </section>
        ...
        <section id="free-resources" className="scroll-mt-24 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mt-20">
          ...
          <p className="mt-3 text-sm text-white/45 max-w-3xl">All 13 approved Free Resources are finalized with customer-safe website delivery, a focused quick win, and a related Business Bloom paid path when deeper implementation is useful.</p>
